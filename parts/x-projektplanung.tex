...
\begin{itemize}
    ...
    \item Der Roboter kann noch nicht von einem Knoten zum Nachbarsknoten fahren.
\end{itemize}
...
\begin{itemize}
    ...
    \item Risiko 15: Akkustand ist zu niedrig: Durch die einfache Austauschbarkeit das Akkus, ist dies kein Problem, da ein zweiter Akku vorhanden ist.
\end{itemize}
...
\begin{itemize}
    ...
    \item Risiko 21: Ausgehende Linien werden nicht erkannt: Sehr robuste Methode und Prozess wurde definiert und implementiert, falls keine Linien erkannt werden.
\end{itemize}
\newpage
...
In diesem Sprint wurde ein YOLO Model trainiert, das sicher Objekte erkennen kann. Ebenfalls kann das Model in der Navigation ausgewertet werden und der Roboter kann somit auf die einzelnen Objekte passend reagieren. 
...
In diesem Sprint konnte  das Problem mit dem Drehen behoben werden. Der Roboter kann sich nun drehen. Dadurch konnte nun der Vorgang, um das Hindernis zu besieitgen erfolgreich implementiert werden.
...
\begin{enumerate}
    ...
    \item Risiko 8: Hindernisse werden beim Anhaben verschoben: Die Greifmethode ist sehr sicher, die Funktion wurde getestet und hat gut funktioniert.
\end{enumerate}

Weiterhin besteht das Risiko, dass die Steuerung als System noch nicht funktioniert. Dies wird versucht zu überwinden bis zum Wettbewerb.
...
Es muss daran gearbeitet werden, Stories aufzubrechen und sie zu schätzen.
...
Es waren 180 Stunden Aufwand pro Person geplant, also 22.5 Personentage. Dies wurde ziemlich genau eingehalten. Bei dem Aufwand der Dokumentation und für die wöchentlichen Besprechungen handelt es sich um Schätzwerte.
