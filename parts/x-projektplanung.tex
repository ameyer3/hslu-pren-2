...
Der Liniensensor konnte ebenfalls optimiert werden, damit die Knoten besser erkannt werden, wenn der Roboter sich auf einem befindet. Ebenfalls wurde das Problem behoben, dass der Roboter noch nicht konsistent eine bestimmte Strecke vor und zureck fahren konnte. Dies kann er nun.

In diesem Sprint konnte der Ultraschall implementiert werden. Es gibt nun eine Funktion, die konstant misst, ob sich Objekte nah vor dem Roboter befinden. Jedoch war es zeitlich nicht mehr moeglich, die Funktion zu implementieren, um den Greifvorgang durchzufuehren.

In diesem Sprint konnte ebenfalls das Problem mit dem Drehen nicht behoben werden. Der Roboter ist zu diesem Moment noch nicht in der Lage sich zu drehen. Bis zu dem Wettbewerb soll jedoch weiter versucht werden, dies zum Laufen zu bringen.
...
\hline
MPU-6050 3-Axis Accelerometer with Gyroscopel& 1 & CHF 9.90 & CHF 9.00\\
\hline
