...
Die Barriere soll mit der Kamera erkannt werden, bevor der Roboter beginnt auf die Linie zu fahren. Der Raspberry Pi wird der Steuerung mitteilen, dass auf der naechsten Strecke eine Barriere zu erwarten ist.
...
% Da das Drehen jedoch eine essentielle Funktion ist, wurde als Alternative der Liniensensor verwendet. Dieser erkennt, wann eine Linie verlassen oder wieder erreicht wurde, und kann somit zur Steuerung des Drehvorgangs genutzt werden – etwa zum Fortsetzen oder Beenden der Drehung. Der Roboter kann dabei sowohl nach links als auch nach rechts gedreht werden, was für die Effizienz mit dem Algorithmus entscheidend ist.
...
Die eigenständige Software um ausgehende Linien zu erkennen wurde schon in \acrshort{pren1} umgesetzt und intensiv getestet. In \acrshort{pren2} musste die Umsetzung nur noch in die Funktion des Roboters integriert werden.
