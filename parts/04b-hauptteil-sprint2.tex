...
In diesem Kapitel wird die Umsetzung der Wegfindung beschrieben. Ziel davon ist es, dass der schnellste Weg im Graphen zum Ziel gefunden werden kann und die Kommunikation zwischen Navigation und Steuerung durchgeführt werden kann. Die einzelnen Tasks sind im Anhang im Kapitel \nameref{projektplanung} nachzulesen.
...
Der gesamte Sourcecode zu der Navigation kann im elektronischen Anhang als ZIP Datei gefunden werden.
...
Der Wert der Nachkorrektur ist 12cm und wurde experimentell ermittelt. Diese Experimente sind im Anhang im Kapitel \nameref{hindernis-nachkorrektur} zu finden. Durch diesen Nachkorrektur ist der Roboter in der Lage, das Hindernis an den selben Ort wieder hinzustellen. Durch diese Tests kann erneut Risiko 8 (Hindernisse werden verschoben) gemindert werden.
