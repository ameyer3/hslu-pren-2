...
Durch verschiedene Environment Variablen\footnote{\url{https://de.wikipedia.org/wiki/Umgebungsvariable}} kann die Hardware und den Funktionsumfang dynamisch gewählt werden. Nachfolgend in Tabelle \ref{table:environment-variables}


\begin{table}
    \centering
    \begin{tabularx}{\textwidth}{|X|X|X|X|}
        \textbf{Environment Variable} & \textbf{} &  & \\
         &  &  & \\
         &  &  & \\
    \end{tabularx}
    \caption{Caption}
